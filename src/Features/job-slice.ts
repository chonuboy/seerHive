...
export interface JobFormData {
  ...
  jobLocations:ClientLocationDto[]|null
}
...
const jobSlice = createSlice({
  ...
  reducers: {
    ...
    updateAddJobFormData: (state, action: PayloadAction<Partial<JobFormData>>) => {
...
export const { setCurrentStep, updateAddJobFormData, nextStep, prevStep, resetForm } = jobSlice.actions
