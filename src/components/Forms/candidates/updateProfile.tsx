...
const ProfileUpdateForm = ({
  ...
  return (
    <div className="min-h-screen bg-white mt-4 p-6 rounded-md">
      <div className="rounded-2xl space-y-4">
        {/* Header */}
        <div className=" py-2 border-b flex items-center gap-1 border-gray-200">
          <svg
        ...
        <form className="p-4" onSubmit={formik.handleSubmit}>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-6">
              ...
              {/* Gender */}
              <div>
                <label htmlFor="gender" className="block text-md font-semibold">
                  Gender
                </label>
                <select
                  id="gender"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  {["Onsite", "Remote", "Hybrid", "Flexible"].map((option) => {
                    const isChecked =
                      option === "Onsite"
                        ? isOnsite ||
                          isFlexible ||
